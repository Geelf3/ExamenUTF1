...
public class Animal {
	...
	public String toString(){
		return "El codi de l'animal és: " + this.getCodi() + ", és de raça " + this.getBreed() + " amb un pes de " + this.getPes() + " i " 
						+ this.getPotes() + " potes. El seu preu de venta és de: " + this.getPreuVendaCanal();
	}
